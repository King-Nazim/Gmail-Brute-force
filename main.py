    ...
    layout = [[sg.Menu(menu_def)],
              [sg.Text('', size=(32,1), font=('Helvetica', 9)),
                 sg.Button('', key='paypal', size=(12,1), font=('Helvetica', 9), button_color=(sg.theme_background_color(), sg.theme_background_color()),
                           image_filename='assets/paypal.png', image_size=(80, 50), image_subsample=2, border_width=0),
                 sg.Button('', key='bitcoin', size=(12,1), font=('Helvetica', 9), button_color=(sg.theme_background_color(), sg.theme_background_color()),
                           image_filename='assets/bitcoin.png', image_size=(80, 60), image_subsample=2, border_width=0)],   
              ...
              [sg.Button('Start Attack', font=('Helvetica', 9), size=(8, 1), bind_return_key=True)]]
...
def main():
    ...
    while True:
        ...
        if event in (None, 'Exit'):
            ...
            window.disappear()
            sg.popup('About:', 'Created by NazimCp And Arjun', 'Gmail Hack', 'Version 1.1')
            window.reappear()
